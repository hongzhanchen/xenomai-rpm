 ...
 * Ring handlers.
 */
static inline int rt2x00_pci_alloc_ring(struct _rt2x00_core *core,
...
static int rt2x00_pci_alloc_rings(struct _rt2x00_core *core)
{
	...
	if (rt2x00_pci_alloc_ring
	    (core, &rt2x00pci->rx, RING_RX, RX_ENTRIES, DATA_FRAME_SIZE,
	     SIZE_DESCRIPTOR)
...
static void
rt2x00_register_read(const struct _rt2x00_pci *rt2x00pci,
...
static void
rt2x00_register_multiread(const struct _rt2x00_pci *rt2x00pci,
			  const unsigned long offset, u32 * value,
			  const u16 length)
{
...
static void
rt2x00_register_write(const struct _rt2x00_pci *rt2x00pci,
...
static void
rt2x00_register_multiwrite(const struct _rt2x00_pci *rt2x00pci,
			   const unsigned long offset, u32 * value,
			   const u16 length)
{
...
static void
rt2x00_bbp_regwrite(const struct _rt2x00_pci *rt2x00pci, const u8 reg_id,
		    const u8 value)
{
...
static void
rt2x00_bbp_regread(const struct _rt2x00_pci *rt2x00pci, const u8 reg_id,
		   u8 * value)
{
...
static void
rt2x00_eeprom_shift_out_bits(const struct _rt2x00_pci *rt2x00pci,
